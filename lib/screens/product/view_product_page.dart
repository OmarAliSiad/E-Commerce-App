...
import 'package:ecommerce/screens/product/components/rating_bottomSheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: appBarLeadingColor),
          ...
          child: Column(
            children: <Widget>[
              ProductOption(
                ...
                selectedColor: {'index': active, 'color': activeColor},
              ),
              description,
              Padding(
                padding: const EdgeInsets.all(24.0),
